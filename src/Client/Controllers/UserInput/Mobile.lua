...
function Mobile:Init()
	...
	self.TouchStarted    = Aero.Event.new()
	self.TouchEnded      = Aero.Event.new()
	self.TouchMoved      = Aero.Event.new()
	self.TouchTapInWorld = Aero.Event.new()
	self.TouchPinch      = Aero.Event.new()
