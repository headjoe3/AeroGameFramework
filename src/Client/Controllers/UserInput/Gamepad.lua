...
function Gamepad.new(gamepad)
	...
	self.ButtonDown   = Aero.Event.new()
	self.ButtonUp     = Aero.Event.new()
	self.Changed      = Aero.Event.new()
	self.Connected    = Aero.Event.new()
	self.Disconnected = Aero.Event.new()
	
	self._listeners = Aero.ListenerList.new()
