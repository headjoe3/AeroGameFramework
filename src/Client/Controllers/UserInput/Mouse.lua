...
function Mouse:Init()
	...
	self.RightDown  = Aero.Event.new()
	self.RightUp    = Aero.Event.new()
	self.MiddleDown = Aero.Event.new()
	self.MiddleUp   = Aero.Event.new()
	self.Moved      = Aero.Event.new()
	self.Scrolled   = Aero.Event.new()
